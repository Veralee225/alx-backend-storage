...
2. `email`, string (255 characters), never null and unique
3. `name`, string (255 characters)
4. `country`, enumeration of countries: `US`, `CO` and `TN`, never null (= default will be the first element of the enumeration, here `US`)
...
1. They score are under (strict) to 80
2. *AND* no `last_meeting` date OR more than a month
